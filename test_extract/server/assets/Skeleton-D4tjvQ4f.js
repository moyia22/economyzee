import { al as clsx, g as cn } from "./router-BxZ3CosB.js";
import { a1 as commonjsGlobal, Q as getDefaultExportFromCjs, r as reactExports, U as React, V as jsxRuntimeExports } from "./worker-entry-CMu_oXBf.js";
...
function CustomTooltip({ active, payload, label, previousData }) {
  if (!active || !payload?.length) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-tooltip rounded-xl px-4 py-3 shadow-xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-2 text-[11px] font-medium uppercase tracking-wider text-muted-foreground", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", children: payload.map((entry, i) => {
      const prevValue = previousData?.[label || ""]?.[entry.dataKey];
      const delta = prevValue ? (entry.value - prevValue) / prevValue * 100 : null;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: entry.dataKey === "income" ? "Receita" : "Despesa" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold tabular-nums text-foreground", children: formatBRL(entry.value) }),
          delta !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
              className: `text-[10px] font-medium tabular-nums ${delta >= 0 ? "text-success" : "text-destructive"}`,
              children: [
                delta >= 0 ? "+" : "",
                delta.toFixed(1),
                "%"
...
function CategoryTooltip({ active, payload }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-tooltip rounded-xl px-4 py-3 shadow-xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-foreground", children: entry.payload.name || entry.name })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm font-semibold tabular-nums text-foreground", children: formatBRL(entry.value) })
  ] });
}
...
function KpiSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "surface-card animate-fade-in-up rounded-xl border border-border/60 p-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-3 w-24" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-8 rounded-lg" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "mt-4 h-7 w-32" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-14 rounded-md" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-3 w-20" })
    ] })
  ] });
}
function ChartSkeleton({ height = "260px" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "surface-card animate-fade-in-up rounded-xl border border-border/60 p-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-start justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-32" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "mt-1.5 h-3 w-48" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-20" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-end gap-1.5", style: { height }, children: Array.from({ length: 8 }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Skeleton,
      {
...
function ListSkeleton({ rows = 5 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "surface-card animate-fade-in-up rounded-xl border border-border/60 p-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-32" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: Array.from({ length: rows }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-9 w-9 shrink-0 rounded-lg" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-3.5 w-2/3" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "mt-1.5 h-2.5 w-1/3" })
      ] }),
...
function DashboardSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-4 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartSkeleton, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChartSkeleton, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-4 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ListSkeleton, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ListSkeleton, { rows: 3 })
    ] })
  ] });
}
export {
  ...
  getMaxRadius as K,
  Legend as L,
  getPercentValue as M,
  warn as N,
  formatAxisMap$1 as O,
  Sector as P,
  ...
  XAxis as X,
  YAxis as Y,
  CategoryTooltip as a,
  CustomTooltip as b,
  Area as c,
  filterProps as d,
  require_baseGt as e,
  formatAxisMap2 as f,
  generateCategoricalChart as g,
  require_baseIteratee as h,
  require_baseLt as i,
  isFunction as j,
  Text as k,
  Layer as l,
  getTickClassName as m,
  adaptEventsOfChild as n,
  Label as o,
  polarToCartesian as p,
  Dot as q,
  require_baseExtremum as r,
  Curve as s,
  isNil as t,
  getValueByDataKey as u,
  Animate as v,
  get as w,
  interpolateNumber$2 as x,
  isEqual as y,
  isNumber as z
};
